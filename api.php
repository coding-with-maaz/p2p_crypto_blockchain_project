 ...
 * ==========================================================
 *
 * API main file. This file listens the POST queries and return the result. © 2022-2025 boxcoin.dev. All rights reserved.
 *
 */
...
function bxc_api_verify_key() {
    ...
    if (!BXC_CLOUD && $_POST['api-key'] !== bxc_settings_get('api-key')) {
