 ...
 * ==========================================================
 *
 * Main JavaScript admin file. © 2022-2025 boxcoin.dev. All rights reserved.
 *  
 */
...
(function () {
    ...
    */
    ...
    var BXCAdmin = {
        ...
        explorer: function (cryptocurrency, value, type = 'address') {
            ...
            if (value.toString().indexOf('cus_') === 0) {
    ...
    */
    ...
    function cloudURL(url = '', include_cloud_key = true) {
        ...
        main.on('click', '#bxc-save-checkout', function () {
            ...
            ajax('save-checkout', { checkout: JSON.stringify(checkout) }, (response) => {
                ...
                if (Number.isInteger(response)) {
                    ...
                    BXCCheckout.embed(checkout.slug ? checkout.slug : checkout.id);
                    card('Checkout saved successfully');
                } else {
