 ...
 * ==========================================================
 *
 * Main JavaScript file used on both admin and client sides. © 2022-2025 boxcoin.dev. All rights reserved.
 * 
 */
...
(function () {
    ...
    */
    ...
    _.init.prototype.map = function (map_function) {
        let response = [];
        for (var i = 0; i < this.e.length; i++) {
            response.push(map_function(_(this.e[i])));
        }
        return response;
    }
    ...
    var BOXCoin = {
        ...
        metamask: {
            ...
            transaction: async function (value, to, token = false, onSuccess = false) {
                ...
                if (!value.toString().substr(0, 2) !== '0x') {
